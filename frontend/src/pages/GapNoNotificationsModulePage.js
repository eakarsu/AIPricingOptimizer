...
// Gap (Non-AI): No notifications module
// No notifications module
import React, { useState } from 'react';

export default function GapNoNotificationsModulePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-notifications-module/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No notifications module</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No notifications module</p>
