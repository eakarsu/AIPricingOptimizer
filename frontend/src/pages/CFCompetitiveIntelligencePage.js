...
// Custom Feature: Competitive intelligence
// Competitive intelligence: Monitor competitor pricing; AI detects pricing wars; suggests win-back strategies or price matching
import React, { useState } from 'react';

export default function CFCompetitiveIntelligencePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-competitive-intelligence/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Competitive intelligence</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Competitive intelligence: Monitor competitor pricing; AI detects pricing wars; suggests win-back strategies or price matching</p>
