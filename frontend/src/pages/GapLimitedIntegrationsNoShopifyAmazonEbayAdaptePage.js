...
// Gap (Non-AI): Limited integrations (no Shopify/Amazon/eBay adapters visible)
// Limited integrations (no Shopify/Amazon/eBay adapters visible)
import React, { useState } from 'react';

export default function GapLimitedIntegrationsNoShopifyAmazonEbayAdaptePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-integrations-no-shopify-amazon-ebay-adapte/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Limited integrations (no Shopify/Amazon/eBay adapters visible)</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Limited integrations (no Shopify/Amazon/eBay adapters visible)</p>
