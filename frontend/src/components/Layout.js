...
const Layout = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/pricing-simulation', label: 'Pricing Simulation', icon: '🧪', isNew: true },
    { path: '/ai-usage-stats', label: 'AI Usage Stats', icon: '📊', isNew: true },
    { path: '/bulk-price-update', label: 'Bulk Price Update', icon: '💰', isNew: true },
